...
// main.ts
var SETTINGS_FILE_POLL_INTERVAL_MS = 3e4;
var MOVE_ACTIONS = [
...
var CustomSortPlugin = class extends import_obsidian3.Plugin {
  constructor() {
    ...
    this.settingsFileSignature = null;
  ...
  async checkForExternalSettingsChange() {
    if (this.checkingExternalSettings)
      return;
    ...
    try {
      ...
      if (nextSignature === this.settingsFileSignature)
        return;
      try {
        await this.loadSettings();
      } catch (error) {
